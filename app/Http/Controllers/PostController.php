...
class PostController extends Controller
{
    public function index(Request $request)
    {
        ...
        $postTypeObj = null;
        if (!in_array($type, ['post', 'page']) && Schema::hasTable('custom_post_types')) {
    ...
    public function create(Request $request)
    {
        ...
        // Fetch CPT Object
        $postTypeObj = null;
        if (!in_array($request->type, ['post', 'page']) && Schema::hasTable('custom_post_types')) {
    ...
    public function edit(Request $request)
    {
        ...
        // Fetch CPT Object
        $postTypeObj = null;
        if (!in_array($post->type, ['post', 'page']) && Schema::hasTable('custom_post_types')) {
